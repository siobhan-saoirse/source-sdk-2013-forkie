...
void CBossAlpha::Spawn(void)
{
	...
	ChangeTeam(TF_TEAM_PVE_INVADERS /* was TF_TEAM_RED */);
...
void CBossAlpha::Update(void)
{
	...
	if (m_hateTauntTimer.IsElapsed())
	{
		...
		CollectPlayers(&playerVector, TF_TEAM_PVE_DEFENDERS /* was TF_TEAM_BLUE */, COLLECT_ONLY_LIVING_PLAYERS);
...
void CBossAlpha::UpdateNearestVisibleEnemy(void)
{
	...
	// collect everyone
	CUtlVector< CTFPlayer* > playerVector;
	//CollectPlayers( &playerVector, TF_TEAM_PVE_INVADERS /* was TF_TEAM_RED */, COLLECT_ONLY_LIVING_PLAYERS );
	CollectPlayers(&playerVector, TF_TEAM_PVE_DEFENDERS /* was TF_TEAM_BLUE */, COLLECT_ONLY_LIVING_PLAYERS, APPEND_PLAYERS);
